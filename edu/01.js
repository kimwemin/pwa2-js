...
// let name2 = '둘리';
// let name22 = '도우너';
// 2. 작성한 코드 상, 선언보다 사용을 먼저 할 경우, 오류가 발생하지 않고, 접근 가능한 현상
console.log(age);
var age = 20;

// 3. var는 기본적으로 함수 레벨 스코프
// 스코프의 종류 : 전역 스코프, 지역 스코프, 블록레벨 스코프
// var globalVar = 'globelVar';
// let globalLet = 'globelLet';
// const globalConst = 'globalConset';

// function test() {
//   var localVar = 'localVar';
//   let localLet = 'localLet';
//   const localConst = 'localConset';
