...
// 자바스크립트에서 월을 인식할 때 0~11로 인식한다.

// Date 인스턴스
const now = new Date();
const date1 = new Date('1990-02-23 14:30:00');
const date2 = new Date(1980, 10, 10, 23, 0, 1); // 사용하는 경우 드뭄
...
// getMonth() : 월 획득, (**주의** 0~11로 반환, 1월이 0)
// 정확한 월을 획득하고 싶다면 아래 코드처럼 '+ 1' 해주어야 한다.
...
// getDay() : 요일을 반환(**주의** 0~6을 반환, 0 = 일요일)
